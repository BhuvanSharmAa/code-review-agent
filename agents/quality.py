...
def quality_node(state: ReviewState) -> dict:
    ...
    system_instruction = (
        "You are a strict code quality reviewer. Analyze the provided code diff for formatting, complexity, and maintainability. "
    ...
    try:
        ...
        raw_text = f"SEVERITY: LOW\nSDK Quality Connection Error: {str(e)}"
    ...
    return {"quality_findings": [{"agent": "quality", "raw": raw_text, "severity": sev}]}